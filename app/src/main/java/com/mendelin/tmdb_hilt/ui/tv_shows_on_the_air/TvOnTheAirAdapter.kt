...
class TvOnTheAirAdapter @Inject constructor(val repository: FavoritesRepository) : PagingDataAdapter<TvListResultItem, TvOnTheAirAdapter.NowPlayingMoviesViewHolder>(NowPlayingMoviesDiffCallBack()) {
