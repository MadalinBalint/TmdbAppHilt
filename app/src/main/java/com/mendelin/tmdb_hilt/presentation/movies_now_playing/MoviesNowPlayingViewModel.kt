...
@HiltViewModel
class MoviesNowPlayingViewModel @Inject constructor(val favorites: FavoritesRepository, val repo: MoviesRepository, val preferences: PreferencesRepository) : BaseViewModel() {
