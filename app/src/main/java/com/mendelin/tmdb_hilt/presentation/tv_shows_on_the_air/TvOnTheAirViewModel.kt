...
@HiltViewModel
class TvOnTheAirViewModel @Inject constructor(val favorites: FavoritesRepository, val repository: TvShowsRepository, val preferences: PreferencesRepository) : BaseViewModel() {
